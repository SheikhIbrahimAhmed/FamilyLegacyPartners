  ...
  return (
    <div className="relative w-full h-full mt-8 p-8 shadow-lg">
      ...
      <div className="absolute top-0 flex items-center justify-start ml-8  w-full h-80">
        <div className="bg-slate-100 bg-opacity-60 p-4 rounded-md shadow-lg text-center max-w-xs w-full h-40 sm:w-full sm:h-48 md:w-full md:h-56 sm:mt-24 md:mt-44 lg:w-full lg:h-60 lg:mt-64 xl:w-5/6 xl:h-5/6 ">
          <div className="text-sm mb-2">
            {/* Separate div elements for different lines */}
            <div className="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl md:text- leading-20 font-sans text-685b44">
              {heading}
            </div>
